...
document.addEventListener("DOMContentLoaded", function(){
    ...
    <div class="button" onclick="ShowFeedBack()"></div>
    <div class="content">
        ...
        <p class="title">چقدر طراحی ظاهری کانال برای شما رضایت بخش بوده ؟</p>
        <div class="emojis">
        ...
        <div class="input">
            ...
            <button class="send">بفرست</button>
